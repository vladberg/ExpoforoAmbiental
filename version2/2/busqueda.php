...
<table summary="Tabla con los datos de los resultados de la búsqueda" class="table1 table table-bordered">
 ...
 $query="select * from registro where nombre_empresa like '%".$busca."%' or giro like'%".$busca."%' order by nombre_empresa asc";
   if($ordenar == '1'){
          ...
          if ($ordenar == '2') {
             ...
             $query="select * from registro order by giro;";
               ...
               $query="select * from registro order by idregistro asc;";
