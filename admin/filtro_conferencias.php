...
<?	
   ...
   <div id="page-wrapper">
        ...
        <div class="row">
          <div class="col-lg-10">
            <h2 style="color:#FE0000;padding-left: 150px">ADMINISTRADOR DE CONFERENCIAS</h2>
          </div>
        </div>
		...
		<div class="row">
          <div class="col-lg-10">
            <div class="row">
  	          <div class="col-md-6"><h1>Conferencias</h1></div>
              <div class="col-md-6" align="right"><h2><a href="admin.si.conferencias.php?opc=ADD&id=0" class="btn btn-success">Agregar Conferencia</a></h2></div>
            </div>
            <div class="table-responsive">
              <table class="table table-bordered table-hover table-striped tablesorter">
                ...
                <?
							...
							$query="SELECT * FROM conferencias order by fecha asc;";
                  ...
                  <tr class="<?php echo $class; ?>" id="row<? echo $icont; ?>">
                    <td><a href="admin.si.conferencias.php?<? echo "id=".$row['idconferencias']."&opc=UPD"; ?>&rowId=row<? echo $icont; ?>"><img src="img/editar.gif" border="0"/><? echo $row['orden']; ?></a></td>
                    <td><? echo html_entity_decode($row['responsable'], ENT_QUOTES); ?></td>
                    <td><? echo html_entity_decode($row['conferencia'], ENT_QUOTES); ?></td>
                    <td><? echo html_entity_decode($row['fecha'], ENT_QUOTES); ?></td>
                    <td><? echo html_entity_decode($row['hora'], ENT_QUOTES); ?></td>
                    <td><img src="img/<?php echo $imagen;?>"/></td>
                    <td><a href="eliminar_conferencia.php?id=<?php echo $row['idconferencias']; ?>" onclick="return confirmar('¿Está seguro que desea eliminar el registro?')"><img src="img/delete.gif" border="0"  title="Eliminar Seccion"  style="cursor:pointer;"  /></a></td>
                  </tr>
                  <? }
              ...
              <? if(mysql_num_rows($resultado) <= 0){?>
         <h1 style="text-align:center;" class="danger">No hay Conferencias capturadas por el momento</h1>
         <?php }?>
            </div>
          </div>
         </div>
